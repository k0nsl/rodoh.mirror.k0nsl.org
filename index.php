...
<head>
    ...
    <script type="text/javascript" src="//rodoh.mirror.k0nsl.org/js/jquery.min.js"></script>
    <script>
		var vseLightbox = {};
    ...
    <script type="text/javascript" src="//rodoh.mirror.k0nsl.org/js/resizer.js"></script>
    <script type="text/javascript" src="//rodoh.mirror.k0nsl.org/js/lightbox.min.js"></script>
    <link href="//rodoh.mirror.k0nsl.org/css/lightbox.min.css" rel="stylesheet" type="text/css" media="screen"/>
...
<div class="footer">
    <br />
    <p>This mirror is operated by <a href="https://k0nsl.org/blog" target="_blank">k0nsl</a> and powered by <a href="https://bad.goy.su/2mw1xPr" target="_blank">BuyVM</a>.</p>
</div>';
...
function display_article($article)
{
    ...
    <div class="article">
        ...
        <p class="source"><small>'.__('Source:').' <a href="'.escape($article['url']).'">'.escape($article['url']).'</a></small></p>
        <br style="clear: both;" />
    </div>';
}
...
function get_css()
{
    ...
    * { margin: 0; padding: 0; }
    body { font-family:"Open Sans", sans-serif; background-color: #F6F6F6; padding: 1%; color: #000; }
    img { max-width: 100%; height: auto; }
    .header h1 { text-shadow: 2px 2px 2px #000; }
    .header h1 a { text-decoration: none; color: #eee; }
    .header { padding: 1% 3%; color: #eee; margin: 0 10%; background-color: #0084C4; background-image: -webkit-linear-gradient(top, #003F5E 0%, #005C8A 2px, #0084C4 92px, #0084C4 100%); background-image: linear-gradient(to bottom, #003F5E 0%,#005C8A 2px,#0084C4 92px,#0084C4 100%); background-repeat: repeat-x; border: 1px solid #4f91b6; }
    .header p a { color: #bbb; }
    .header p a:hover { color:#cc3300; text-decoration:none;}
